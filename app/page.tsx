...
const dict = {
  ...
  ru: {
    ...
    coursesSub: "Структурированные учебные материалы от начального (Beginner) до продвинутого (Advanced) уровней.",
...
export default async function Home() {
  ...
  // Level selector translations configuration
      ...
      <main className="flex-1">
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-2 flex-wrap animate-fade-in">
